...
public class CameraControlTrigger : MonoBehaviour
{
    ...
    {
        if (_player._rb.velocity.y > _speed && customInspectorObject.panDirection.Equals(PanDirection.Down))
        {
            customInspectorObject.panDirection = PanDirection.Up;
        }
        else if (_player._rb.velocity.y < _speed && customInspectorObject.panDirection.Equals(PanDirection.Up))
        {
